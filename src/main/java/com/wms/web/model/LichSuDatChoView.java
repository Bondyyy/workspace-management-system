...
public class LichSuDatChoView {
    ...
    private final List<DichVuTrongPhienView> dichVuDaDung;

    public LichSuDatChoView(String maPhien, String maDatCho, String maHoaDon, String maQR,
                              ...
                              LocalDateTime ngayLapHoaDon, List<DichVuTrongPhienView> dichVuDaDung) {
    ...
    public List<DichVuTrongPhienView> getDichVuDaDung() {
        return dichVuDaDung;
    }
}
