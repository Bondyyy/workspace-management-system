...
public class DatChoView {
    ...
    public DatChoView(String maDatCho, String hoTen, String tenKhongGian, String tenChiNhanh,
                       LocalDateTime thoiGianDuKienToi, Integer khoangThoiGianSuDung,
                       String trangThaiDatTruoc, BigDecimal thanhTien, String ghiChu) {
