...
public class QuanLyLoaiKhongGianForm extends javax.swing.JDialog {
    ...
    private void btnThemMoiActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (tenLoai.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập Tên loại không gian!", "Cảnh báo",
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Đơn giá không hợp lệ! Vui lòng nhập số.", "Lỗi",
        ...
        if (!sucChuaStr.isEmpty()) {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Sức chứa không hợp lệ! Vui lòng nhập số nguyên.", "Lỗi",
                        JOptionPane.ERROR_MESSAGE);
        ...
        if (loaiKhongGianDAO.them(dto)) {
            ...
            JOptionPane.showMessageDialog(this, "Thêm loại không gian thất bại! Kiểm tra kết nối DB.", "Lỗi",
                    JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void btnCapNhatActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (maLoai.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn 1 loại từ bảng để cập nhật!", "Thông báo",
                    JOptionPane.WARNING_MESSAGE);
            return;
        }
