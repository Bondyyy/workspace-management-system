...
public class QuanLyHoiVienForm extends javax.swing.JPanel {
    ...
    private void btnQuanLyHangActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        QuanLyHangTVForm form = new QuanLyHangTVForm((Frame) parentWindow, true);
    ...
    private void btnDoiAnhActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                Image img = icon.getImage().getScaledInstance(lblAnhDaiDien.getWidth(), lblAnhDaiDien.getHeight(), Image.SCALE_SMOOTH);
