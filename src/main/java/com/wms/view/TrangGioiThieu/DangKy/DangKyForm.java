package com.wms.view.TrangGioiThieu.DangKy;
...
public class DangKyForm extends javax.swing.JPanel {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (win instanceof com.wms.view.TrangGioiThieu.TrangGioiThieuForm) {
            ((com.wms.view.TrangGioiThieu.TrangGioiThieuForm) win).showLoginForm();
        }
    }
