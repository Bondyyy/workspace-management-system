...
public class DangNhapForm extends javax.swing.JPanel {
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        if (win instanceof com.wms.view.TrangGioiThieu.TrangGioiThieuForm) {
            ((com.wms.view.TrangGioiThieu.TrangGioiThieuForm) win).showRegisterForm();
        } else {
