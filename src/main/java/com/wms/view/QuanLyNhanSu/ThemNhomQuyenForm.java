...
public class ThemNhomQuyenForm extends JPanel {
    ...
    private void initComponents() {
        ...
        TitledBorder borderInfo = BorderFactory.createTitledBorder(BorderFactory.createLineBorder(COLOR_PINK_DARK, 2), "Thông Tin Nhóm Quyền");
        ...
        // Khu vực Dropdown Autocomplete và Nút Thêm
        ...
        pnlChonQuyen.add(btnThemQuyen, BorderLayout.EAST);
        ...
        btnLuu = new JButton("Lưu Nhóm Quyền");
    ...
    private void xuLyLuu() {
        ...
        JOptionPane.showMessageDialog(this, "Thêm nhóm quyền " + tenNhom + " thành công!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
        
        // Sau khi lưu xong thì xóa form và tự động quay lại trang quản lý
        clearForm();
        xuLyQuayLai();
    }
    ...
    private void clearForm() {
        txtTenNhom.setText("");
        txtMoTa.setText("");
        tableModel.setRowCount(0); // Xóa sạch bảng quyền đã chọn
        JTextField txtEditor = (JTextField) cboPhanQuyen.getEditor().getEditorComponent();
        txtEditor.setText("");
    }
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Test Thêm Nhóm Quyền (JPanel)");
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.setSize(700, 600);
            frame.setLocationRelativeTo(null);
            
            // Nhúng JPanel vào JFrame
            frame.add(new ThemNhomQuyenForm());
