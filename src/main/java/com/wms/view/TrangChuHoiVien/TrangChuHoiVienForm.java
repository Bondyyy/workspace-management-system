...
public class TrangChuHoiVienForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TrangChuHoiVienForm
     */
    ...
    private void btnMenuDatChoActionPerformed(java.awt.event.ActionEvent evt) {
        javax.swing.JOptionPane.showMessageDialog(this, "Tính năng đang phát triển!");
    }
    ...
    private void btnDangXuatActionPerformed(java.awt.event.ActionEvent evt) {
        this.dispose();
        try {
            new com.wms.view.TrangGioiThieu.TrangGioiThieuForm().setVisible(true);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
