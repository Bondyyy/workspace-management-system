...
public class ThanhToanHoaDonForm extends JPanel {
    ...
    private void kiemTraMaGiamGia() {
        ...
        com.wms.model.ThanhToan_KhuyenMai.XacNhanPhieuGiamGiaDTO validationResult = 
    ...
    private void moManHinhTienMat() {
        ...
        ThanhToanTienMatForm dialog = new ThanhToanTienMatForm(parentFrame, thanhTien);
    ...
    private void moManHinhChuyenKhoan() {
        ...
        JFrame parentFrame = (JFrame) javax.swing.SwingUtilities.getWindowAncestor(this);
        ThanhToanChuyenKhoanForm dialog = new ThanhToanChuyenKhoanForm(parentFrame, thanhTien);
        dialog.setVisible(true);
