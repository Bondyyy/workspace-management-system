 ...
 */
package com.wms.view.TrangChu.TrangChuHoiVien.DatChoKhongGian.XemChiNhanh;
import java.awt.*;
...
public class XemChiNhanhForm extends javax.swing.JPanel {
    ...
    private void loadDanhSachChiNhanh() {
        try {
            ...
            List<com.wms.model.CoSoVatChat.ChiNhanhDTO> dsTuDB = chiNhanhDAO.layDanhSachChiNhanh();
            if (dsTuDB != null && !dsTuDB.isEmpty()) {
                List<ModelChiNhanh> danhSach = new java.util.ArrayList<>();
                for (com.wms.model.CoSoVatChat.ChiNhanhDTO db : dsTuDB) {
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {                                           
        if (chiNhanhDangChon != null) {
            ...
            if (window instanceof com.wms.view.TrangChu.TrangChuHoiVien.TrangChuHoiVienForm) {
                ((com.wms.view.TrangChu.TrangChuHoiVien.TrangChuHoiVienForm) window).showPanel(
                    new com.wms.view.TrangChu.TrangChuHoiVien.DatChoKhongGian.XemSoDoKhongGian.XemSoDoKhongGianForm(chiNhanhDangChon.ma, chiNhanhDangChon.ten)
                );
            }
        }
    }
