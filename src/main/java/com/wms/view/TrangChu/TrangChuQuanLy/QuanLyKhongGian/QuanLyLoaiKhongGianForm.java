...
public class QuanLyLoaiKhongGianForm extends javax.swing.JDialog {
    ...
    public QuanLyLoaiKhongGianForm(java.awt.Frame parent, boolean modal) {
        ...
        initComponents();
        taiDanhSach(null);
        txtMaLoaiKG.setText(generateMaLoai());
        this.pack();
    ...
    private void taiDanhSach(String tuKhoa) {
        ...
        model.setRowCount(0);
        List<LoaiKhongGianDTO> list = loaiKhongGianDAO.timKiemLoaiKhongGian(tuKhoa);
        for (LoaiKhongGianDTO dto : list) {
            String sucChua = dto.getSucChua() != null ? String.valueOf(dto.getSucChua()) : "-";
            String donGia  = dto.getDonGiaTheoGio() != null
                    ? FORMAT_TIEN.format(dto.getDonGiaTheoGio()) : "-";
    ...
    private void btnThemMoiActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (tenLoai.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập Tên loại không gian!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
            txtTenLoaiKG.requestFocus();
            return;
        }
        ...
        if (!sucChuaStr.isEmpty()) {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Sức chứa không hợp lệ! Vui lòng nhập số nguyên.", "Lỗi", JOptionPane.ERROR_MESSAGE);
        ...
        if (loaiKhongGianDAO.them(dto)) {
            JOptionPane.showMessageDialog(this,
                    "Thêm loại không gian \"" + tenLoai + "\" thành công!\nMã tự động: " + dto.getMaLoaiKG(),
                    "Thành công", JOptionPane.INFORMATION_MESSAGE);
            taiDanhSach(null);
            laMoiForm();
        } else {
            JOptionPane.showMessageDialog(this, "Thêm loại không gian thất bại! Kiểm tra kết nối DB.", "Lỗi", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void btnCapNhatActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (maLoai.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn 1 loại từ bảng để cập nhật!", "Thông báo", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        int confirm = JOptionPane.showConfirmDialog(this,
                "Bạn có chắc muốn cập nhật loại \"" + maLoai + "\"?",
        ...
        if (loaiKhongGianDAO.capNhat(dto)) {
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyLoaiKhongGianForm.class.getName())
                    .log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>

        java.awt.EventQueue.invokeLater(() -> {
            QuanLyLoaiKhongGianForm dialog = new QuanLyLoaiKhongGianForm(new javax.swing.JFrame(), true);
