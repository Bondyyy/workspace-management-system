...
public class QuanLySoDoKhongGianForm extends javax.swing.JDialog {
    ...
    private java.util.List<com.wms.model.CoSoVatChat.KhongGianDTO> dsKG;
    ...
    private void taiDanhSach() {
        ...
        for (com.wms.model.CoSoVatChat.KhongGianDTO dto : dsKG) {
    ...
    private void veSoDo() {
        ...
        for (com.wms.model.CoSoVatChat.KhongGianDTO kg : dsKG) {
    ...
    private void btnCapNhatToaDoActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            com.wms.model.CoSoVatChat.KhongGianDTO dto = dsKG.get(row);
            dto.setToaDoX(x);
            dto.setToaDoY(y);
            dto.setChieuDai(w);
            dto.setChieuRong(h);
