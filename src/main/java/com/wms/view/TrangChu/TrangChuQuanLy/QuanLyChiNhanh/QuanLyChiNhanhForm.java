package com.wms.view.TrangChu.TrangChuQuanLy.QuanLyChiNhanh;
...
public class QuanLyChiNhanhForm extends javax.swing.JPanel {
    ...
    private void loadTableData() {
        ...
        java.util.List<com.wms.model.CoSoVatChat.ChiNhanhDTO> list = controller.layDanhSach();
        for (com.wms.model.CoSoVatChat.ChiNhanhDTO cn : list) {
    ...
    private void fillForm(int row) {
        ...
        txtHotline.setText((String) tblChiNhanh.getValueAt(row, 5));
    ...
    private void btnThemMoiActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            com.wms.model.CoSoVatChat.ChiNhanhDTO cn = new com.wms.model.CoSoVatChat.ChiNhanhDTO();
            ...
            cn.setDuongDayNong(txtHotline.getText());
            cn.setTrangThai(cbxTrangThai.getSelectedItem().toString());
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        tableModel.setRowCount(0);
        java.util.List<com.wms.model.CoSoVatChat.ChiNhanhDTO> list = controller.timKiem(keyword);
        for (com.wms.model.CoSoVatChat.ChiNhanhDTO cn : list) {
            tableModel.addRow(new Object[]{
                cn.getMaCN(),
                cn.getTenCN(),
    ...
    private void cbxNguoiQuanLyActionPerformed(java.awt.event.ActionEvent evt) {
    }
    /**
    ...
    private void initComponents() {
        ...
        lblGioMoCua.setText("Giờ mở cửa (VD: 07:00)");
        pnMain.add(lblGioMoCua);
        lblGioMoCua.setBounds(20, 200, 170, 18);
