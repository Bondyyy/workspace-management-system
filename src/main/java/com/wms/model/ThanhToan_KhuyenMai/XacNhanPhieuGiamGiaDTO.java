...
/**
 * DTO để trả về kết quả kiểm tra phiếu giảm giá
 */
public class XacNhanPhieuGiamGiaDTO {
    ...
    // Constructor cho trường hợp valid
    ...
    public PhieuGiamGiaDTO getVoucherInfo() {
        return voucherInfo;
    }
    ...
    public void setVoucherInfo(PhieuGiamGiaDTO voucherInfo) {
        this.voucherInfo = voucherInfo;
    }
