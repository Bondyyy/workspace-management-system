package com.wms.model.TrangChuHoiVien;
...
public class DatChoDTO {
    ...
    public void setMaDatCho(String maDatCho) { this.maDatCho = maDatCho; }
    ...
    public Timestamp getThoiGianDuKienToi() { return thoiGianDuKienToi; }
    public void setThoiGianDuKienToi(Timestamp thoiGianDuKienToi) { this.thoiGianDuKienToi = thoiGianDuKienToi; }

    public Integer getKhoangThoiGianSuDung() { return khoangThoiGianSuDung; }
    public void setKhoangThoiGianSuDung(Integer khoangThoiGianSuDung) { this.khoangThoiGianSuDung = khoangThoiGianSuDung; }

    public String getTrangThaiDatTruoc() { return trangThaiDatTruoc; }
    public void setTrangThaiDatTruoc(String trangThaiDatTruoc) { this.trangThaiDatTruoc = trangThaiDatTruoc; }
